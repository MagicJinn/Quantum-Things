...
{
	public static final String CATEGORY_PLANTS = "Worldgen Plants";
	public static final String CATEGORY_FEATURES = "Worldgen Features";
	public static final String CATEGORY_LOOT = "Worldgen Loot";
