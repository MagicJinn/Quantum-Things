...
public class SpectreCoils {
	private static final String CATEGORY = "Spectre Coils";
    ...
    @ConfigOption(category = CATEGORY, name = "GenesisSpectreGeneratesEnergy", comment = "Whether the Genesis Spectre Coil generates energy, or just transfers energy from the player's Injector with no limit")
