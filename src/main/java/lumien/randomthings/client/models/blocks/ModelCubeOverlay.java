...
public class ModelCubeOverlay implements IBakedModel
{
	...
	{
		Vec3d c1 = rotate(new Vec3d(x1 - .5, y - .5, z1 - .5), side).add(.5, 0.5, .5);
		Vec3d c2 = rotate(new Vec3d(x1 - .5, y - .5, z2 - .5), side).add(.5, 0.5, .5);
		Vec3d c3 = rotate(new Vec3d(x2 - .5, y - .5, z2 - .5), side).add(.5, 0.5, .5);
		Vec3d c4 = rotate(new Vec3d(x2 - .5, y - .5, z1 - .5), side).add(.5, 0.5, .5);
		...
		return new BakedQuad(Ints.concat(vertexToInts((float) c1.x, (float) c1.y, (float) c1.z, -1, texture, 0, 0, side), vertexToInts((float) c2.x, (float) c2.y, (float) c2.z, -1, texture, 0, 16, side), vertexToInts((float) c3.x, (float) c3.y, (float) c3.z, -1, texture, 16, 16, side), vertexToInts((float) c4.x, (float) c4.y, (float) c4.z, -1, texture, 16, 0, side)), -1, side, texture, false, DefaultVertexFormats.ITEM);
	}
