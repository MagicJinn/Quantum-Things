...
public class GuiEnumButton<E extends Enum> extends GuiButton
{
	Field field;
	...
	public GuiEnumButton(int buttonId, int x, int y, int widthIn, int heightIn, ResourceLocation textureLocation, Class clazz, String fieldName, Object instance)
	{
