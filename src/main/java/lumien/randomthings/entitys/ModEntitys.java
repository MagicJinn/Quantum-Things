...
public class ModEntitys
{
	public static void init()
	{
		...
		registerEntity(EntitySpirit.class, "spirit", 1, RandomThings.instance, 80, 1, true);
		registerEntity(EntityArtificialEndPortal.class, "artificialEndPortal", 2, RandomThings.instance, 80, 1, true);
		registerEntity(EntityProjectedItem.class, "projectedItem", 3, RandomThings.instance, 80, 20, false);
		registerEntity(EntityTemporaryFlooFireplace.class, "flooFirePlace", 4, RandomThings.instance, 80, 20, false);
		registerEntity(EntityFallingBlockSpecial.class, "fallingBlockSpecial", 5, RandomThings.instance, 160, 20, true);
		registerEntity(EntityGoldenChicken.class, "goldenChicken", 6, RandomThings.instance, 80, 3, true);
		registerEntity(EntityGoldenEgg.class, "goldenEgg", 7, RandomThings.instance, 64, 10, true);
