...
public class BlockRedstonePlate extends BlockBase implements INoItem
{
	...
	public void neighborChanged(IBlockState state, World worldIn, BlockPos pos, Block neighborBlock, BlockPos changedPos)
	{
		...
		checkForRedstone(state, worldIn, pos);
	}
	...
	private void checkForRedstone(IBlockState state, World worldIn, BlockPos pos)
	{
		...
		if (currentlyPowered != shouldBePowered)
		{
			if (shouldBePowered)
			{
				worldIn.setBlockState(pos, ModBlocks.redstonePlatePowered.getStateFromMeta(this.getMetaFromState(state)));
			}
			else
			{
				worldIn.setBlockState(pos, ModBlocks.redstonePlate.getStateFromMeta(this.getMetaFromState(state)));
			}
		}
	...
	public void onEntityCollision(World worldIn, BlockPos pos, IBlockState state, Entity entityIn)
	{
		...
		EnumFacing currentInput = state.getValue(INPUT_FACING);
		EnumFacing currentOutput = powered ? currentInput.getOpposite() : state.getValue(OUTPUT_FACING);
