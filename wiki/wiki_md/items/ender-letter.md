...
*Note that you can only
      ...
      items from a received Ender Letter, once the letter is empty it will vanish.*

## Crafting

---

![](../images/rtwiki_images_crafting_ender-letter-1.png)![](../images/rtwiki_images_crafting_ender-letter-2.png)