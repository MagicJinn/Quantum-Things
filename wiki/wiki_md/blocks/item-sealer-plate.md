...
The Item Sealer Plate is a special block that can be placed on top of solid blocks. It has no collision box, allowing entities to pass through it, but it affects item entities that move over it.
...
TODO
![](../images/crafting_item-sealer-plate.webp)
