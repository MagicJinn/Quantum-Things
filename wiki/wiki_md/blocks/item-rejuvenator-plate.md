...
The Item Rejuvenator Plate is a flat plate that can be placed on top of solid blocks. It has no collision box, allowing entities to pass through it, but it affects item entities that move over it.
...
![](../images/crafting_item-rejuvenator-plate.webp)
